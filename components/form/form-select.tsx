...
type FormSelectProps = {
  ...
  selectProps?: Partial<ReactSelectProps> &
    Partial<CreatableProps<Option, boolean, GroupBase<Option>>>;
};
          ...
          <FormControl>
            <Controller
              ...
              render={({ field: { onChange, value, ref, ...restField } }) => {
                const selectPropsToPass = isCreatable
                  ? selectProps
                  : Object.fromEntries(
                      Object.entries(selectProps || {}).filter(
                        ([key]) => key !== 'onCreateOption'
                      )
                    );
                return (
                  <SelectComponent<Option, boolean, GroupBase<Option>>
                    {...restField}
                    ref={ref}
                    options={options}
                    value={
